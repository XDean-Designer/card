...
|------|-----|
| flow | `card-issue-new` |
| 原型深链 | [`demo.html?flow=card-issue-new&capture=1`](../demo.html?flow=card-issue-new&capture=1) |
| 对照截图 | [`captures/card-issue-new.png`](../captures/card-issue-new.png)（若缺失则先跑 capture 脚本） |
| DOM/Screen | `overlay` |
| 说明 | 单选→去结账 |
