...
|------|-----|
| flow | `list-shelved` |
| 原型深链 | [`demo.html?flow=list-shelved&capture=1`](../demo.html?flow=list-shelved&capture=1) |
| 对照截图 | [`captures/list-shelved.png`](../captures/list-shelved.png)（若缺失则先跑 capture 脚本） |
| DOM/Screen | `screen0` |
| 说明 | 已下架 Tab；footer 无办卡 |
