...
|------|-----|
| flow | `detail-active` |
| 原型深链 | [`demo.html?flow=detail-active&capture=1`](../demo.html?flow=detail-active&capture=1) |
| 对照截图 | [`captures/detail-active.png`](../captures/detail-active.png)（若缺失则先跑 capture 脚本） |
| DOM/Screen | `screen6` |
| 说明 | 顶栏下架/编辑；运营数据+卡面 |
