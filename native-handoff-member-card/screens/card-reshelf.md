...
|------|-----|
| flow | `card-reshelf` |
| 原型深链 | [`demo.html?flow=card-reshelf&capture=1`](../demo.html?flow=card-reshelf&capture=1) |
| 对照截图 | [`captures/card-reshelf.png`](../captures/card-reshelf.png)（若缺失则先跑 capture 脚本） |
| DOM/Screen | `overlay` |
| 说明 | Dialog |
