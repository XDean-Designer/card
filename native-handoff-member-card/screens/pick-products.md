...
|------|-----|
| flow | `pick-products` |
| 原型深链 | [`demo.html?flow=pick-products&capture=1`](../demo.html?flow=pick-products&capture=1) |
| 对照截图 | [`captures/pick-products.png`](../captures/pick-products.png)（若缺失则先跑 capture 脚本） |
| DOM/Screen | `screen2p` |
| 说明 | 行内数量 |
