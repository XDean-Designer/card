...
|------|-----|
| flow | `card-extend` |
| 原型深链 | [`demo.html?flow=card-extend&capture=1`](../demo.html?flow=card-extend&capture=1) |
| 对照截图 | [`captures/card-extend.png`](../captures/card-extend.png)（若缺失则先跑 capture 脚本） |
| DOM/Screen | `overlay` |
| 说明 | 时长+参考费用 |
