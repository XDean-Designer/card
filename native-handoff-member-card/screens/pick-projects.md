...
|------|-----|
| flow | `pick-projects` |
| 原型深链 | [`demo.html?flow=pick-projects&capture=1`](../demo.html?flow=pick-projects&capture=1) |
| 对照截图 | [`captures/pick-projects.png`](../captures/pick-projects.png)（若缺失则先跑 capture 脚本） |
| DOM/Screen | `screen2` |
| 说明 | 价目项目+计次参数 |
