...
|------|-----|
| flow | `card-refund` |
| 原型深链 | [`demo.html?flow=card-refund&capture=1`](../demo.html?flow=card-refund&capture=1) |
| 对照截图 | [`captures/card-refund.png`](../captures/card-refund.png)（若缺失则先跑 capture 脚本） |
| DOM/Screen | `overlay` |
| 说明 | 建议退款可改 |
