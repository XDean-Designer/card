...
3. 项目可被会员卡权益 **按名称绑定**；绑卡后 **锁定名称、手机端可预约、删除**；**在售/下架仍可改**（细则见完整稿）。删除锁定以锁标呈现。  
...
| 页面/层 | 导航标题（原型） | 说明 |
|---------|------------------|------|
| 列表 | 价目表 | Tab 项目/产品；标题栏品牌红「+添加」按钮跟 Tab 直接新建（不弹窗；无悬浮球）；项目列名称/时长/价格；产品列名称（规格）/价格 |
